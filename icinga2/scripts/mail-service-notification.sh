...
ICINGAWEBURL="http://chn-opmon.growipx.com/icingaweb2/dashboard#!/icingaweb2/monitoring/service/history?host=$HOSTDISPLAYNAME&service=$SERVICENAME"
FROMNAME="CHN-OPMON Alerts"
FROMEMAIL="opmon-alerts@iopex.com"
